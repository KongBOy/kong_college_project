...
static void Perspective_trans(double x,double y,Mat warp_matrix,double & result_x,double& result_y)
{
                ...
                Mat UI_bass,string UI_WINDOW_NAME)
{
    ...
    for(int go_staff = 0 ; go_staff < staff_count ; go_staff++)
    {
        for(int go_line = 0 ; go_line < 5 ; go_line++)
        {
            ...
            Perspective_trans(trans_left_x,trans_left_y,warp_matrix,trans_left_x,trans_left_y);
            ...
            Perspective_trans(trans_right_x,trans_right_y,warp_matrix,trans_right_x,trans_right_y);
