...
/*
static Mat template_img_4 = imread("note/4/4.bmp",0);
static Mat template_img_5 = imread("note/4-rest/4-rest.bmp",0);
static Mat template_img_2 = imread("note/2/2.bmp",0);
static Mat template_img_0 = imread("note/0/0.bmp",0);
static Mat template_img_1 = imread("note/0-rest/0-rest.bmp",0);
static Mat template_img_3 = imread("note/2-rest/2-rest.bmp",0);
static Mat template_img_8 = imread("note/8-rest/8-rest-3.bmp",0);
static Mat template_img_6 = imread("note/6-rest/6-rest-2.bmp",0);
static Mat template_img_7 = imread("note/32-rest/7-2.bmp",0);
*/
void set_formate(int head_type,int time_bar,Scalar & color , Mat & template_img)
{
    Mat template_img_4 = imread("note/4/4.bmp",0);
    Mat template_img_5 = imread("note/4-rest/4-rest.bmp",0);
    ...
    Mat template_img_7 = imread("note/32-rest/7-2.bmp",0);

    Mat template_img_9 = imread("note/9/9-bin.bmp",0);
